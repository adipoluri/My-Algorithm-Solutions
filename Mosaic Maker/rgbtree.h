...
public:
   ...
   * 
    ...
    */
    ...
    //Recursive Helper for Constructor to enable creation of KD tree
    void treeHelper(int start, int end, int d);
    ...
    int absDist(const RGBAPixel& query, const RGBAPixel& curr) const;

    //Recursive Helper for the nearest Neighbour Method
    int NearestNeighborHelper(const RGBAPixel & query, int start, int end, int curDim, int bestSoFar) const;
